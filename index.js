...
let message_agree = "Do agree to the terms and conditions";
...
function displayTable() {
  ...
  for (let i = 0; i < entries.length; i++) {
    str += `<tr>
                    <center><td>${entries[i].name}</td></center>
                    <center><td>${entries[i].email}</td></center>
                    <center><td>${entries[i].password}</td></center>
                    <center><td>${entries[i].dob}</td></center>
                    <center><td>${entries[i].checked}</td></center>
                </tr>\n`;
  }
  table.innerHTML = str;
}
